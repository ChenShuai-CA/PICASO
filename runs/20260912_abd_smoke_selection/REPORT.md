...
|---|---|---|---|---:|---:|---:|---:|---|
| V14_T56_R1.txt | CCRs | zero_br_unknown_repeat_1 | unknown | 24.792 | 0.884 | -11.419 | 0.000..0.000 | unknown_aeb_or_driver_brake |
| V14_T56_R2.txt | CCRs | zero_br_unknown_repeat_2 | unknown | 25.162 | 0.689 | -10.388 | 0.000..0.000 | unknown_aeb_or_driver_brake |
| V14_T133_R2.txt | CCFT | zero_br_unknown_turning | unknown | 37.883 | 0.173 | -10.024 | 0.000..0.000 | unknown_aeb_or_driver_brake |
| V14_T503_R4.txt | CPTA | zero_br_unknown_turning | unknown | 41.444 | 0.695 | -6.119 | 0.000..0.000 | unknown_aeb_or_driver_brake |
...
Human review is entered only in `manual_intervention_review.csv`. Allowed values are `none_confirmed`, `manual`, and `unknown`. Re-run this script after editing; it validates the four paths and preserves the review file.
