"""Teacher-forced decode probe: separates decode-path error from token drift.
...
CHECKPOINT = REPO / "runs/20260913_p332_model_smoke/m2_final_checkpoint.pt"
...
result = {
    ...
    "interpretation": "ground_truth row isolates decode path + residual head "
                      ...
                      "error without sampling/autoregressive drift",
}
